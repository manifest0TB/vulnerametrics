...
<template>
  <!-- NAVBAR -->
  <nav v-if="authStore.isAuthenticated" class="fixed top-0 left-0 w-full bg-[#FAFAFA] shadow z-50 flex items-center justify-between px-8 h-16" style="font-family: 'Roboto', sans-serif;">
    ...
    <div class="flex items-center space-x-6">
      ...
      <button v-if="authStore.isAuthenticated" @click="handleLogout" class="bg-[#21C063] hover:bg-[#16994A] text-white px-4 py-2 rounded-lg shadow transition">Logout</button>
    </div>
  </nav>
